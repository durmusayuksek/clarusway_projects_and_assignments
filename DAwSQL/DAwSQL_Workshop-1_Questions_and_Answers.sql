---Soru_1: List the staff that Jane Destrey is the manager of
...
---Soru_2: List bikes that are more expensive than the “Trek CrossRip – 2020” bike.
...
---Soru_3: List customers whose order dates are before Arla Ellis.
...
---Soru_4: List all customers who orders on the same dates as Abby Parks.
...
---Soru_5: List products in categories other than Cruisers Bicycles, Mountain Bikes, or Road Bikes in 2018.
...
---Soru_6: List bikes that have a model year equal to 2020 and have prices more than all electric bikes.
...
---Soru_7: List bikes that model model year equal to 2020 and its prices more than any electric bikes.
...
---Soru_8: Write a query that returns the state where “Trek Remedy 9.8 – 2019” product is not ordered.
...
---Soru_9: List customers who have an order prior to the last order of a customer 
...
---Soru_10: Create a table with a number in each row in ascending order from 0 to 9.
...
---Soru_12: Write a query that returns brands that have products for both 2018 and 2019.
...
---Soru_13: Write a query that returns customers who have orders for both 2018, 2019, and 2020.
...
---Soru_14: Write a query that returns brands that have a 2018 model product but not a 2019 model product.
...
---Soru_15: Write a query that returns only products ordered in 2019 (not ordered in other years).
...
---Soru_16: Add a column to the sales.staffs table containing the store names of the employees.
...
---Soru_17: List customers who bought both “Electric Bikes” and “Comfort Bicycles” and “Children Bicycles” in the same order.
...
---Soru_18: Create a new column that contains labels of the shipping speed of products.
...
---Soru_19: Write a query that returns orders that are shipped more than two days after the ordered date.
...
---Soru_20: Write a query that returns the number of distributions of the orders 
...
---Soru_21: Write a query that returns the order numbers of the states by months.
...
---Soru_22: How many yahoo mails in customer’s email column? Use Case expression and Patindex function.
...
---Soru_24: Add a new column to the customers table that contains the customer’s contact information. 
...
---Soru_25: Write a query that returns streets. The third character of the streets is numerical.

select street,
case when isnumeric(substring(street, 3, 1)) = 1 then substring(street, 3, 1) else substring(street, 1, 1) end as third_char
from sale.customer

---Soru_26: Split the values in the email column into two parts with “@”
